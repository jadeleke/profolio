		...
		<div className="p-5 top-0 sticky scroll z-50 bg-gray-100 shadow dark:bg-gray-700">
			<navbar className="flex justify-between items-center text-gray-600 dark:text-gray-400 container ml-auto mr-auto">
				...
				<ul className="flex gap-3 text-3xl">
					<li>
						<a href="https://www.linkedin.com/in/joseph-adeleke-27b43314" target="_blank" rel="noreferrer">
							<AiFillLinkedin />
						</a>
					</li>
					<li>
						<a href="https://gitlab.com/Adeleke-joseph" target="_blank" rel="noreferrer">
							<AiFillGitlab />
						</a>
					</li>
					<li>
						<a href="https://github.com/jadeleke" target="_blank" rel="noreferrer">
							<AiFillGithub />
						</a>
					</li>
				</ul>
